...
function summaryCards(kind: string, fields: ScalarRecord) {
  const keys: Record<string, ReportColumn[]> = {
    ...
    "sales-calls": [{ key: "totalCalls", label: "Calls" }, { key: "paymentSalesCount", label: "Sales" }, { key: "cashCollectedMinor", label: "Cash Collected", format: "money" }, { key: "closeRate", label: "Close Rate", format: "percent" }],
  };
