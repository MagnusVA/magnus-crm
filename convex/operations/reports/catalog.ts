...
export const REPORT_SECTION_DEPENDENCIES: Readonly<Record<string, readonly string[]>> = {
  ...
  sales_calls_summary: ["sales_meeting_stats", "sales_payments"],
  sales_closer: ["user_dimension", "sales_meeting_stats", "sales_payments"],
  sales_program: ["program_dimension", "sales_meeting_stats", "sales_payments"],
