...
| **Gate 4** | After B + C | No-show action bar works (confirm / reschedule / follow-up). Reschedule chain displayed on meeting detail. Lead Manager at `/workspace/leads` — search, detail sheet, direct merge (all roles) with audit trail. |
